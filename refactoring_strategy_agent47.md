# Refactoring Strategy: CPU Kernels (NN & Control Flow) (Part 7 of 10)
...
When the C++ files for the CPU Kernels (NN & Control Flow) (Part 7) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
