# Refactoring Strategy: Common Definitions & Memory Management (Part 5 of 5) - Agent 15
...
When the C++ files for the Common Definitions & Memory Management (Part 5) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
