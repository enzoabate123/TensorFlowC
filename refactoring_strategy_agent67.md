# Refactoring Strategy: Profiler & Debugger (Part 2 of 5)
...
When the C++ files for the Profiler & Debugger (Part 2) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
