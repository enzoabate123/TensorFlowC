# Refactoring Strategy: Eager Execution Basics (Part 1 of 5)
...
When the C++ files for the Eager Execution Basics (Part 1) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
