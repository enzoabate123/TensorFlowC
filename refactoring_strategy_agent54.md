# Refactoring Strategy: GPU/TPU Device Integration (Part 4 of 5)
...
When the C++ files for the GPU/TPU Device Integration (Part 4) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
