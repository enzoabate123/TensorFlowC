# Refactoring Strategy: Distributed Runtime (Part 6 of 10)
...
When the C++ files for the Distributed Runtime (Part 6) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
