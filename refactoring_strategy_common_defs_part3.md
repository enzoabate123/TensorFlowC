# Refactoring Strategy: Common Definitions & Memory Management (Part 3 of 5)
...
When the C++ files for the Common Definitions & Memory Management (Part 3) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
