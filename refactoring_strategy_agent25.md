# Refactoring Strategy: Graph Representation & Parsing (Part 10 of 10)
...
When the C++ files for the Graph Representation & Parsing (Part 10) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
