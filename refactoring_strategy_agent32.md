# Refactoring Strategy: CPU Kernels (Math & Basic) (Part 2 of 10) - Agent 32
...
When the C++ files for the CPU Kernels (Math & Basic) (Part 2) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
