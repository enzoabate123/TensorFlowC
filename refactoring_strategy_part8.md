# Refactoring Strategy: Core Platform & Utilities (Part 8 of 10)
...
When the C++ files for the Core Platform & Utilities (Part 8) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
