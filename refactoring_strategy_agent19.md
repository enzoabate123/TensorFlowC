# Refactoring Strategy: Graph Representation & Parsing (Part 4 of 10) - Agent 19
...
When the C++ files for the Graph Representation & Parsing (Part 4) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
...
2. **Function Signatures**:
   ...
   - The first argument of these functions will be a pointer to the respective `struct` (e.g., `Graph_parse(Graph* g)`).
