# Refactoring Strategy: CPU Kernels (Math & Basic) (Part 6 of 10) - Agent 36
...
When the C++ files for the CPU Kernels (Math & Basic) (Part 6 of 10) are added, the following strict refactoring rules will be applied to rewrite the codebase to strict C99/C11:
